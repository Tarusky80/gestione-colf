...
urlpatterns = [
    ...
    # BUSTE PAGA PERSISTENTI (ARCHIVIO)
    ...
    # STORICO VARIAZIONI CONTRATTUALI
    ...
    # ACCESSO DATORE (area riservata)
    path('datore/login/', views.datore_login, name='datore_login'),
    path('datore/logout/', views.datore_logout, name='datore_logout'),
    path('datore/', views.datore_dashboard, name='datore_dashboard'),
    path('datore/download/<int:pk>/', views.datore_download_documento, name='datore_download'),

    # AJAX ADMIN — gestione accesso datori e visibilità documenti
    ...
    # GESTIONE DATABASE (Sistema → Database)
    ...
    path('ajax/datore-richiedi-modifica/', views.ajax_datore_richiedi_modifica, name='ajax_datore_richiedi_modifica'),

...
- **✅ Fix encoding JS** — riestratto con Python (UTF-8) dopo corruzione PowerShell (â€”→—)
- **✅ Fix label form scuri** — 20 class duplicati unificati in ajax_form.html/progetto.html
- **✅ Pulizia**: rimossi 39 file Conflicted copy NAS + .py temp + test_db journal
- **✅ `.gitignore`** aggiornato
- 31/31 test OK, `manage.py check` OK
- **Commit**: `9e5f020`
